...
const pfire = pokemon.filter(p => p.types.includes("fire"));
//console.log(pfire);
...
const nNormal = pokemon.filter(p => p.types.includes("normal")).length;
console.log(`There are ${nNormal} pokemons of normal type`)